...
>(
  (
    ...
    return (
      <div
        ref={ref}
        className="group peer hidden text-sidebar-foreground md:block" // Hidden on mobile, block on md
        data-state={state}
      ...
      >
        ...
        <div
          ...
          style={{ width: state === "collapsed" && collapsible === "offcanvas" ? "0" : "var(--sidebar-width)" }}
        />
        <div
          className={cn(
